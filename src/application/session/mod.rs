...
//!
//! The trait and its test double live here, in the application layer; the
//! transports that implement it for real are adapters in
//! [`crate::infrastructure::net::session`].

mod fake;

use std::time::Duration;

use wyven_net::{Channel, PlayerId};

use crate::application::protocol::{ClientMessage, ServerMessage};
