...
//!
//! The rules are pure and live in [`crate::inventory::crafting`]; this is the
...
use crate::inventory::crafting::{
    Availability, CraftError, KnownItems, STATION_RADIUS, StationSet, availability, craft,
    stations_near,
};
use crate::net::{Channel, ChatKind, ClientMessage};
use crate::ui::crafting::{CraftAction, RecipeEntry};
...
impl InGameState {
    ...
    pub(super) fn item_name(&self, item: crate::inventory::ItemId) -> &str {
        self.content
            .item_display_names
            .get(item.0 as usize)
            .map(String::as_str)
