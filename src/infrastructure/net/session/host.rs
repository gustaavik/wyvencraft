...
use crate::application::session::{Authority, Inbound, Session};
use crate::infrastructure::net::{Channel, ClientMessage, Host, PlayerId, ServerMessage};
...
impl Session for HostSession {
    ...
    fn local_id(&self) -> PlayerId {
        crate::application::session::HOST_PLAYER_ID
    }
