...
impl FileServerStore {
    ...
    pub fn new() -> Self {
        Self::at(crate::infrastructure::paths::servers_path())
    }
...
impl ServerStore for FileServerStore {
    ...
    fn save(&mut self, list: &ServerList) -> Result<(), String> {
        ...
        crate::infrastructure::fs::write_atomic(&self.path, text.as_bytes())
...
mod tests {
    use super::*;
    use crate::infrastructure::net::serverlist::ServerEntry;
