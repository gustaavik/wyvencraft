...
use crate::domain::inventory::{ItemId, ItemRegistry, Placeable, Tool};
use crate::domain::world::block::{
...
pub struct GameContent {
    ...
    pub sounds: Arc<crate::infrastructure::audio::SoundRegistry>,
...
impl GameContent {
    ...
    pub fn from_source(source: &dyn ContentSource) -> Arc<Self> {
        ...
        let sounds = Arc::new(load_or_builtin(
            ...
            "sounds",
            &mut (),
            |text, _| crate::infrastructure::audio::SoundRegistry::from_toml(text),
            |_| crate::infrastructure::audio::SoundRegistry::builtin(),
