...
use crate::domain::inventory::{Inventory, ItemRegistry, ItemStack, TOTAL_SLOTS};
...
mod tests {
    ...
    use crate::domain::inventory::ArmorSlot;
    use crate::domain::world::block::blocks;
    use crate::domain::world::{NoiseGenerator, WorldGenerator};
    use std::sync::Arc;
    ...
    fn player_snapshot_roundtrips_and_drops_unknown_items() {
        ...
        let kinds = crate::domain::entity::EntityRegistry::builtin();
