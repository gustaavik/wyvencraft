...
use crate::entity::boss::AttackEffect;
use crate::inventory::{ItemRegistry, Tool};
use crate::world::BlockRegistry;
use crate::world::block::Interaction;
use crate::world::structure::{Cell, StructureConfig};
...
/// satisfies `wanted`.
fn any_block_with(
    structure: &crate::world::structure::StructureDef,
    blocks: &BlockRegistry,
...
mod tests {
    ...
    fn an_altar_for_a_missing_boss_is_reported() {
        let text =
            crate::world::block::BUILTIN_BLOCKS.replace("boss = \"elder stag\"", "boss = \"x\"");
    ...
    fn a_tier_no_tool_meets_is_reported() {
        let text = crate::inventory::item::BUILTIN_ITEMS.replace("tier = 4\n", "tier = 3\n");
