...
//!   [`crate::domain::entity::brain::MobBrain`] it perceives nothing itself and is
//!   seeded, so a fight replays identically under test.
//!
//! Locomotion is still the ordinary hostile [`MobBrain`](crate::domain::entity::brain::MobBrain)
