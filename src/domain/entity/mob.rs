...
use crate::domain::entity::animation::{AnimationState, Motion};
use crate::domain::entity::boss::{BossBrain, BossMove, BossParams, BossSense};
use crate::domain::entity::brain::{Gait, Intent, MobBrain, Perception};
use crate::domain::entity::kind::{EntityKind, MobParams, PhysicsParams, VisualSpec};
...
pub struct Mob {
    ...
    /// friction instead, the same way a [`crate::domain::entity::DroppedItem`] settles.
    impulse: Vec3,
    brain: MobBrain,
