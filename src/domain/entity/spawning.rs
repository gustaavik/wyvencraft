...
pub const BUILTIN_SPAWNING: &str =
    include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/assets/spawning.toml"));
...
mod tests {
    ...
    fn worldgen() -> WorldGenConfig {
        WorldGenConfig::builtin(&crate::domain::world::BlockRegistry::with_builtins())
    }
