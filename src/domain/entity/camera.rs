...
pub struct Shot {
    ...
    pub aim: f32,
    /// Horizontal lens shift, in NDC — see `wyven_render::Camera::projection_offset`.
    pub shift: f32,
}
...
pub(crate) const INSPECT_AIM: f32 = -0.55;
...
impl Shot {
    ...
    ///
    /// Deliberately takes no pitch. [`crate::domain::entity::Perspective::ThirdFront`]
    ...
    /// same reasoning `wyven_render::Camera::near_radius` uses.
