...
//!
//! It does not push. [`SceneCache`](crate::presentation::screens::ingame_state) re-bakes the arm
...
//!   I/O of its own.
//!
//! Drawing lives in [`crate::presentation::ui::editor`], which touches no files and owns no
//! game state.
...
/// [`crate::presentation::ui::icon`] and a block lying on the ground is sized by its drop
