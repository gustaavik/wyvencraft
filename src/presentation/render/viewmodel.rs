...
use crate::presentation::render::rigged::Character;
...
pub struct HandPose {
    ...
    pub yaw: f32,
    pub pitch: f32,
    /// [`crate::domain::entity::AnimationState::swing_progress`].
    pub swing: f32,
    pub walk_phase: f32,
    pub walk_amount: f32,
}
...
mod tests {
    ...
    use crate::presentation::render::rigged::fixture::{Player, walking};
    ...
    fn held_cube(frame: Mat4) -> CpuMesh {
        ...
        crate::domain::world::meshing::push_item_cube(
            &mut cube,
            Vec3::splat(0.5),
            1.0,
            0.0,
