...
//! * [`crate::presentation::ui::multiplayer_menu`] draws it and reports what was clicked.
...
use crate::infrastructure::net::serverlist::FileServerStore;
use crate::infrastructure::net::status::NetStatusProbe;
use crate::presentation::ui::multiplayer_menu::{
    BrowserView, Dialog, DialogFields, MpAction, draw_multiplayer,
};
