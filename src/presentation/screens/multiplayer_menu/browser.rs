...
//! tested against an [`InMemoryServerStore`](crate::infrastructure::net::serverlist::InMemoryServerStore)
//! and a [`FakeStatusProbe`](crate::infrastructure::net::status::FakeStatusProbe), with no
//! window, socket or auth server anywhere near it.

use std::collections::{HashMap, HashSet};
use std::time::Duration;

use crate::infrastructure::net::serverlist::{ServerEntry, ServerList, ServerStore};
use crate::infrastructure::net::status::{StatusOutcome, StatusProbe};
pub use crate::presentation::ui::multiplayer_menu::{RowState, ServerRow};
...
mod tests {
    use super::*;
    use crate::infrastructure::net::serverlist::{InMemoryServerStore, SavedServers};
    use crate::infrastructure::net::status::{FakeStatusProbe, ServerStatus};
