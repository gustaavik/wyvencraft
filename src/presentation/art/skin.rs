...
const EMBEDDED_SKIN: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/assets/textures/entity/player/defaultskin.png"
));
...
/// [`crate::presentation::render::model::HumanoidModel::player`].
...
impl SkinPart {
    ...
    /// [`crate::presentation::render::model`]).
